...
class FFPCybos:
    ...
    def connect(self, id_, pwd, pwdcert):
        if not self.connected():
            ...
            app.start(
                    'C:\Daishin\starter\\ncStarter.exe /prj:cp /id:{id} /pwd:{pwd} /pwdcert:{pwdcert} /autostart'.format(id=id_, pwd=pwd,
                                                                                                                         pwdcert=pwdcert)
                    )
    ...
    def get_multiple_hist_data(self, codes, dtype='종가',
                               end_date=None, c_type='D', l=250, adj='1'):
        """
        ...
        for i, code in enumerate(codes):
            p_data = self.get_hist_data(code, end_date=end_date, c_type=c_type, l=l, adj=adj)
    ...
    def multiPriceData(self, codes, l=250):
        """
...
if __name__ == "__main__":
    ...
    oprice, hprice, lprice, close, vol, tover = cybos.multiPriceData(scodes,
                                                                     l=750)
